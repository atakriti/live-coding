 ...
 */
console.log("\nTask1")
let array1 = [1, 5, 6, 5, 7, 1, 6, 8, 9, 7];
function duplicates(acc,curr) {
...
console.log(array1.reduce(duplicates,[]))
...
//         return acc
//     }
//     console.log(carts.reduce(task2,[]))
// }
function test(user) {
  return carts.filter(item => item.user === user)
}

console.log(test("alkis"))
// console.log(carts.filter(n => n.user === "alkis"))
